			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						<h2><strong>Masuk ke akun</h2></strong>
						 <h4 style='color:red'>
						...
						<form action="<?php echo base_url()?>customer-login" method="post">
							...
							<button type="submit" class="btn btn-default" style="background-color: #1dd1a1;">Masuk</button>
						</form>
					</div><!--/login form-->
				</div>
				<div class="col-sm-1">
					<h2 class="or" style="background-color: #1dd1a1;">OR</h2>
				</div>
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						<h2><strong>Daftar pengguna baru!</h2></strong>
						 <h5 style='color:red'> <?php echo validation_errors();?></h5>
						<form action="<?php echo base_url()?>customer-registration" method="post">
							<input type="text" placeholder="Nama Lengkap" name="cus_name" value="<?php echo set_value('cus_name'); ?>"/>
							...
							<button type="submit" class="btn btn-default" style="background-color: #1dd1a1;">Daftar</button>
						</form>
					</div><!--/sign up form-->
				</div>
			</div>
