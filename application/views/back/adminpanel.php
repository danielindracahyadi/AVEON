        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                        <a href="<?php echo base_url();?>dashboard">Welcome</a>
                    </li>
                    <!-- <li>
                        <a href="<?php echo base_url();?>register-form"><i class="fa fa-user-plus fa-fw"></i>Register User</a>
                    </li> -->
                    <li>
                        <a href="#"><i class="fa fa-tags fa-fw"></i> Opsi Kategori<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                 <a href="<?php echo base_url();?>add-category"><i class=""></i>Tambah Kategori</a>
                             </li>
                             <li>
                                 <a href="<?php echo base_url();?>add-sub-category"><i class=""></i>Tambah Sub Kategori</a>
                             </li>
                            <li>
                                 <a href="<?php echo base_url();?>category-list"><i class=""></i>List Kategori</a>
                            </li>
                            <li>
                                 <a href="<?php echo base_url();?>sub-category-list"><i class=""></i>List Sub Kategori</a>
                            </li>
                        </ul>
                    </li>
                      <li>
                        <a href="#"><i class="fa fa-product-hunt fa-fw"></i> Opsi Produk<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                 <a href="<?php echo base_url();?>add-product"><i class=""></i>Tambah Produk</a>
                             </li>
                            <li>
                                 <a href="<?php echo base_url();?>product-list"><i class=""></i>List Produk</a>
                            </li>
                        </ul>
                    </li>

                    <!-- <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Opsi Brand<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url();?>add-brand">Tambah Brand</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>brand-list">List Brand</a>
                            </li>
                        </ul>
                    </li> -->
                    
                     <li>
                        <a href="<?php echo base_url()?>manage-order"><i class="fa fa-flask fa-fw"></i>Atur Pesanan</a>
                    </li>
                </ul>
                <!-- end side-menu -->
            </div>
